...
set ruler
set runtimepath=~/.vim,~/.vim/bundle/ack,~/.vim/bundle/atp,~/.vim/bundle/command-t,~/.vim/bundle/fugitive,~/.vim/bundle/git,~/.vim/bundle/gundo,~/.vim/bundle/minibufexpl,~/.vim/bundle/nerdtree,~/.vim/bundle/pep8,~/.vim/bundle/py.test,~/.vim/bundle/pydoc,~/.vim/bundle/ropevim,~/.vim/bundle/snipmate,~/.vim/bundle/supertab,~/.vim/bundle/surround,~/.vim/bundle/tasklist,~/.vim/bundle/templates,~/.vim/bundle/vim-pandoc,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim73,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/bundle/snipmate/after,~/.vim/after
set shiftwidth=4
set showmatch
set spelllang=de
set statusline=%F%m%r%h%w\ [FORMAT=%{&ff}]\ [TYPE=%Y]\ ([ASCII=%03.3b]\ [HEX=%02.2B]\ [%03l,%03v\ of\ %L]\ [%p%%])
...
silent only
cd ~/Dokumente/Programmieren/lsthv-oem
...
setlocal tabstop=8
setlocal tags=~/Dokumente/Programmieren/lsthv-oem/.git/python.tags,~/Dokumente/Programmieren/lsthv-oem/.git/tags,./tags,./TAGS,tags,TAGS
setlocal textwidth=0
setlocal thesaurus=
setlocal noundofile
...
21
normal zo
let s:l = 66 - ((23 * winheight(0) + 15) / 31)
...
14
normal zo
let s:l = 39 - ((15 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
39
...
setlocal tabstop=8
setlocal tags=~/Dokumente/Programmieren/lsthv-oem/.git/yaml.tags,~/Dokumente/Programmieren/lsthv-oem/.git/tags,./tags,./TAGS,tags,TAGS
setlocal textwidth=0
setlocal thesaurus=
setlocal noundofile
setlocal nowinfixheight
...
14
normal zo
let s:l = 104 - ((16 * winheight(0) + 9) / 19)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
104
...
setlocal wrap
setlocal wrapmargin=1
let s:l = 61 - ((8 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
61
...
8
normal zo
let s:l = 30 - ((27 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
30
